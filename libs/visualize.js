...
function fn_a(module, exports, __webpack_require__) {
    "use strict";
...
function fn_b(module, exports, __webpack_require__) {
    "use strict";
    ...
    function visualize(fsm) {
        ...
        {
            rankdir: 'LR',
            states: [ 'user', 'archive', 'dep', 'bu', 'umc' ],
            transitions: [
                { from: 'none', to: 'user', label: ' reset ' },
                { from: 'user', to: 'user', label: ' reset ' },
                { from: 'archive', to: 'user', label: ' reset ' },
                { from: 'dep', to: 'user', label: ' reset ' },
                { from: 'bu', to: 'user', label: ' reset ' },
                { from: 'umc', to: 'user', label: ' reset ' },
                { from: 'none', to: 'archive', label: ' finish ' },
                { from: 'user', to: 'archive', label: ' finish ' },
                { from: 'archive', to: 'archive', label: ' finish ' },
                { from: 'dep', to: 'archive', label: ' finish ' },
                { from: 'bu', to: 'archive', label: ' finish ' },
                { from: 'umc', to: 'archive', label: ' finish ' },
                { from: 'user', to: 'dep', label: ' next ' },
                { from: 'dep', to: 'bu', label: ' next ' },
                { from: 'bu', to: 'umc', label: ' next ' },
                { from: 'umc', to: 'archive', label: ' next ' }
            ]
        }
        */
